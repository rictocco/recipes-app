package com.auyamatech.bootstrap;

import com.auyamatech.domain.*;
import com.auyamatech.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private UnitOfMeasureReposirory unitOfMeasureRepository;
    ...
    public RecipeBootstrap(RecipeRepository recipeRepository, CategoryRepository categoryRepository,
        ...
        this.unitOfMeasureRepository = unitOfMeasureReposirory;
    }
    ...
    public List<Recipe> getRecipes() {
        ...
        // Getting all the Unit of Measure
        ...
        log.debug("Recipe best guacamole created");
        ...
        log.debug("Recipe Yummy tacos created");
        return recipes;
    }
}
